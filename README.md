# project-dashboard
1.Complete_Techno_Sales_Data
Built interactive dashboards to track region-wise and product-wise performance.The dashboard focus on highlighting majof sales data like sales, brand, company and emplyoee perfromance

2.Tech Stack
• Data Analysis: Excel, Power BI, SQL, Python (Pandas, NumPy)
• Visualization Tools: Power BI, Excel Charts, Data modelling
• Other Tools: Power Query, DAX, Pivot Tables
